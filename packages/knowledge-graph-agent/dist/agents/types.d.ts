 ...
 */
export type AgentMessageUnion = TaskRequestMessage | TaskResponseMessage | StatusMessage | ErrorMessage | CoordinationMessage;
/**
 * Agent runtime state
 */
 ...
 */
export type AgentFactory<T extends AgentConfig = AgentConfig> = (config: T) => Promise<AgentInstance>;
/**
 ...
 */
export declare function createAgentId(type: AgentType): string;
