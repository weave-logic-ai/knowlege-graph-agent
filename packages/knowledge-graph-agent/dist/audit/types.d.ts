 ...
 * ```
 */
export type KnowledgeGraphEventPayload = NodeCreatedPayload | NodeUpdatedPayload | NodeDeletedPayload | EdgeCreatedPayload | EdgeDeletedPayload | QueryExecutedPayload | WorkflowStartedPayload | WorkflowCompletedPayload | WorkflowStepCompletedPayload | GapDetectedPayload | TaskSpecGeneratedPayload | ConflictDetectedPayload | ConflictResolvedPayload | SyncStartedPayload | SyncCompletedPayload | CheckpointCreatedPayload;
/**
 ...
 * ```
 */
export type ExtractPayload<T extends KnowledgeGraphEventPayload['type']> = Extract<KnowledgeGraphEventPayload, {
    type: T;
}>;
/**
 ...
 */
export declare function createHLC(lastHlc?: HybridLogicalClock): HybridLogicalClock;
/**
 ...
 */
export declare function mergeHLC(local: HybridLogicalClock, remote: HybridLogicalClock): HybridLogicalClock;
