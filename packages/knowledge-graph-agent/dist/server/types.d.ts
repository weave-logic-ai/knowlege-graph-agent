 ...
 * Server event types
 */
export type ServerEventType = 'server:starting' | 'server:started' | 'server:stopping' | 'server:stopped' | 'server:error' | 'request:received' | 'request:completed' | 'request:error' | 'health:check' | 'config:changed';
/**
 ...
 */
export declare const DEFAULT_DATABASE_PATH = ".kg/knowledge.db";
/**
