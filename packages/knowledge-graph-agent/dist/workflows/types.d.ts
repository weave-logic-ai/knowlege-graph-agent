 ...
 */
export type StepHandler<TInput = unknown, TOutput = unknown> = (input: TInput, context: StepContext) => Promise<TOutput>;
/**
 * Rollback handler function type
 */
export type RollbackHandler<TOutput = unknown> = (result: TOutput, context: StepContext) => Promise<void>;
/**
 ...
 */
export type WorkflowEventType = 'workflow:started' | 'workflow:completed' | 'workflow:failed' | 'workflow:cancelled' | 'workflow:paused' | 'workflow:resumed' | 'step:started' | 'step:completed' | 'step:failed' | 'step:skipped' | 'step:retrying' | 'rollback:started' | 'rollback:completed' | 'rollback:failed';
/**
 * Workflow event
 */
