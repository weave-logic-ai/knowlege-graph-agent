...
# ⚠️ ARCHIVED: n8n Workflow Automation

> **Archive Notice**: This documentation has been archived as of 2025-10-23 and replaced by Weaver (workflow.dev) unified workflow proxy.
>
> **Reason**: The project has transitioned to using Weaver as a unified workflow proxy that can dynamically route to multiple workflow engines (n8n, Temporal, Make, Zapier) based on task requirements, eliminating the need for direct n8n integration.
>
> **New Documentation**: See [[../../docs/weaver-workflow-proxy]] for the current workflow automation approach.
>
> **Original Locations**:
> - `features/n8n-workflow-automation.md`
