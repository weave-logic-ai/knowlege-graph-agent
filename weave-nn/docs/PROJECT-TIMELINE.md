...
```mermaid
graph LR
    P1[Phase 1<br/>Basic Wikilinks] --> P3[Phase 3<br/>Node Expansion]
    P3 --> P13[Phase 13<br/>Semantic Search]
    P13 --> P14[Phase 14<br/>Visual Graph]
```
...
```mermaid
graph LR
    P2[Phase 2<br/>Capture] --> P9[Phase 9<br/>Testing Docs]
    P9 --> P12[Phase 12<br/>SOPs]
    P12 --> P14[Phase 14<br/>Dashboards]
```
...
```mermaid
graph LR
    P5[Phase 5<br/>MCP] --> P7[Phase 7<br/>Rules]
    P7 --> P12[Phase 12<br/>Learning Loop]
    P12 --> P13[Phase 13<br/>Advanced Reasoning]
```
...
```mermaid
graph LR
    P4[Phase 4<br/>MVP Plan] --> P10[Phase 10<br/>Launch]
    P10 --> P11[Phase 11<br/>Services]
    P11 --> P14[Phase 14<br/>Polish]
```
...
gantt
    ...
    section Foundation
    Phase 1 Knowledge Graph    :done, p1, 2025-10-20, 2w
    Phase 2 Documentation      :done, p2, after p1, 2w
    Phase 3 Node Expansion     :done, p3, after p2, 2w
    Phase 4B MVP Planning      :done, p4, after p3, 3w

    section Implementation
    Phase 5 MCP Integration    :done, p5, after p4, 2w
    Phase 6 Vault Init         :done, p6, after p5, 3w
    Phase 7 Agent Rules        :active, p7, after p6, 2w
    Phase 8 Git Automation     :active, p8, after p6, 2w
    Phase 9 Testing            :p9, after p7, 2w
    Phase 10 MVP Launch        :done, p10, after p9, 2w

    section Intelligence
    Phase 11 CLI Services      :done, p11, after p10, 3w
    Phase 12 Learning Loop     :done, p12, after p11, 4w
    Phase 13 Intelligence      :active, p13, after p12, 8w

    section Maturity
    Phase 14 Obsidian          :p14, after p13, 8w
```
